...
public class Configuration {
    ...
    public void setEnvironment() {
        if (null != config && !this.isInit) {
            ...
            this.packCapacity = this.getConfig().getInteger(SyuioEnv.PACK_CAPACITY.key, 512);
            if (this.getConfig().getBoolean(SyuioEnv.BUFFER_ORDER.key , false)) {
    ...
    public enum SyuioEnv {
        ...
        PACK_CAPACITY("syuio.pack.capacity"),
        BUFFER_ORDER("syuio.buffer.littleEndian"),
        PORT("syuio.port");
